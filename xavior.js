...
xavior.sendMessage(m.chat, { video: smeme, mimetype: 'video/mp4', fileName: `subrek.mp4`, caption: `Betewe Lu Dah Janji Mau Subscribe\n\nJangan PHP Yah 😊\n\nSubscibe:https://youtube.com/c/XaviorOfc-Bot`},{ quoted: m })} break
            ...
            case 'noenc': {
            ana = fs.readFileSync('./sc/noenc.zip')
            xavior.sendMessage(m.chat, {document: ana, mimetype: 'application/zip', fileName: `noenc.zip`}, {quoted:m})}
            break
...
Lihat list Pesan Dengan ${prefix}listmsg`)
	    ...
	    case 'anonymous': {
            ...
            case 'ping': case 'botstatus': case 'statusbot': {
                ...
                respon = `
Kecepatan Respon ${latensi.toFixed(4)} _Second_ \n ${oldd - neww} _miliseconds_\n\nRuntime : 59 days ${runtime(process.uptime())}
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `Halo Bre Owner Lagi Gabut\n`,
                    description: "*Lihat Kegabutannya*",
                    buttonText: "🗿",
                    footerText: "Lagi Males",
          ...
          listType: 1
            ...
            let btn = [{
                        ...
                        xavior.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.thumb)
                        } else if (setbot.templateVid) {
                        xavior.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.thumb)
